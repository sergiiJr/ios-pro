...
//  Bankey
//
//  Created by Sergii Bala on 5/18/22.
//
...
class OnboardingContainerViewController: UIViewController {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let page2 = OnboardingViewController(heroImageName: "world", titleText: "Make your money around the world quickly and securely.")
